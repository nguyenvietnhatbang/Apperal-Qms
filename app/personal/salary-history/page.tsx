...
export default async function PersonalSalaryHistoryPage() {
  ...
  return <PersonalWorkspace user={user} overview={overview as PersonalOverview} initialMonth={initialMonth} initialView="salary" />;
}
